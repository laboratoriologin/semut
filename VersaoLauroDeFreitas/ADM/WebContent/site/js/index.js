...
function openInfoWindow(marker, ocorrencia){
	...
	if(ocorrencia.imagem){
		...
		img.onload = function() {
			...
			info += '<div style="text-align: center; padding-bottom: 10px;"><img id="imgOcorrenciaInfoWindows" style="width:' + width + '; height: ' + heigh + ';" src="http://177.1.212.50:9004/arquivos_semut_lauro/' + ocorrencia.imagem + '" alt="'  + ocorrencia.situacao + '"/></div>';
		...
		img.src = "http://177.1.212.50:9004/arquivos_semut_lauro/" + ocorrencia.imagem;
