...
public class CadastroActivity extends DefaultActivity {
	...
	public boolean validarCampos() {
		...
		if (TextUtils.isEmpty(((EditText) findViewById(R.cadastro.nome)).getText()) 
				|| TextUtils.isEmpty(((EditText) findViewById(R.cadastro.email)).getText())
				|| TextUtils.isEmpty(((EditText) findViewById(R.cadastro.senha)).getText())
				|| TextUtils.isEmpty(((EditText) findViewById(R.cadastro.confirmar_senha)).getText())
				|| TextUtils.isEmpty(((EditText) findViewById(R.cadastro.senha)).getText().toString().trim()) 
				|| TextUtils.isEmpty(((EditText) findViewById(R.cadastro.confirmar_senha)).getText().toString().trim())) {
		...
		if (((EditText) findViewById(R.cadastro.senha)).getText().toString().contains(" ")){
			Toast.makeText(this, "Senha não pode ter espaço em branco!", Toast.LENGTH_SHORT).show();

			return false;
		}
		
		if (((EditText) findViewById(R.cadastro.confirmar_senha)).getText().toString().contains(" ")){
			Toast.makeText(this, "Senha não pode ter espaço em branco!", Toast.LENGTH_SHORT).show();
