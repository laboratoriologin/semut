...
public class OcorrenciaDAO {
	...
	public List<Ocorrencia> pesquisarOcorrenciasPendentes(GrupoOcorrencia grupo) {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();

		broker.setPropertySQL("ocorrenciadao.pesquisarocorrenciaspendentes", grupo.getId());
