...
public class OcorrenciaDAO {
	...
	public List<Ocorrencia> pesquisarOcorrenciasPendentes(GrupoOcorrencia grupoOcorrencia) {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();

		broker.setPropertySQL("ocorrenciadao.pesquisarocorrenciaspendentes",grupoOcorrencia.getId());
	...
	public QtdPorStatus obterPendentesGeral(GrupoOcorrencia grupo) {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();

		broker.setPropertySQL("ocorrenciadao.obterpendentesgeral",grupo.getId());
