...
public class DetalheNoticiaActivity extends DefaultActivity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// ((ActionBar)
		// findViewById(R.id.actionbar)).setDisplayHomeAsUpEnabled(Boolean.TRUE);
		//
		// noticia = (Noticia) getIntent().getSerializableExtra("noticia");
		//
		// TextView txvChamada = (TextView)
		// findViewById(R.noticiaDetalhe.titulo);
		// txvChamada.setText(noticia.getTitulo());
		//
		// txvChamada.setTextColor(getResources().getColor(R.color.sucom));
		//
		// TextView txvDescricao = (TextView)
		// findViewById(R.noticiaDetalhe.descricao);
		// txvDescricao.setText(noticia.getDescricao());
		//
		// TextView txvDataPublicacao = (TextView)
		// findViewById(R.noticiaDetalhe.data_publicacao);
		// txvDataPublicacao.setText(DateFormat.format("dd/MM/yyyy kk:mm",
		// noticia.getData_publicacao()));
		//
		// ImageView imgDataPublicacao = (ImageView)
		// findViewById(R.noticiaDetalhe.imgNoticiaDetalhe);
		//
		// Button button = (Button)
		// findViewById(R.noticiaDetalhe.compartilhar_button);
		// button.setVisibility(Button.GONE);
		//
		// Button button2 = (Button)
		// findViewById(R.noticiaDetalhe.salvar_button);
		// button2.setVisibility(Button.GONE);
		//
		// ImageView imgDataPublicacao2 = (ImageView)
		// findViewById(R.noticiaDetalhe.imgNoticiaDetalhe);
		//
		// imgDataPublicacao2.setImageDrawable(getResources().getDrawable(R.drawable.avisozero));
		//
		// }
		// else if (idFlag == 4 && ocorrencia != null) {
		// grupo = new Grupo(Constantes.CAT_TRANSALVADOR);
		//
		// this.initColorAndTitleByGrupo(grupo);
		//
		...
		// TextView txvChamada = (TextView)
		// findViewById(R.noticiaDetalhe.titulo);
		// txvChamada.setText("Trânsito");
		//
		// TextView txvDescricao = (TextView)
		// findViewById(R.noticiaDetalhe.descricao);
		// txvDescricao.setText(ocorrencia.getTexto());
		//
		// TextView txvDataPublicacao = (TextView)
		// findViewById(R.noticiaDetalhe.data_publicacao);
		// txvDataPublicacao.setText(SimpleDateFormat.getDateInstance(
		// SimpleDateFormat.SHORT).format(ocorrencia.getData()));
		//
		// ImageView imgDataPublicacao = (ImageView)
		// findViewById(R.noticiaDetalhe.imgNoticiaDetalhe);
		//
		// imgDataPublicacao.setImageDrawable(getResources().getDrawable(
		// R.drawable.acidente));
		//
		// Button button = (Button)
		// findViewById(R.noticiaDetalhe.salvar_button);
