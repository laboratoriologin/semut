...
public class TelefoneActivity extends DefaultActivity implements
OnTouchListener {
	...
	public void onClickSamu(View v){
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri
				.parse(Constantes.TELSAMU));
		startActivity(callIntent);
	}
	
	public void onClickBomb(View v){
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri
				.parse(Constantes.TELBOMB));
		startActivity(callIntent);
	}
	
	public void onClickDefesa(View v){
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri
				.parse(Constantes.TELDEFESA));
		startActivity(callIntent);
	}
	
	public void onClickPolicia(View v){
		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri
				.parse(Constantes.TELPOLICIA));
		startActivity(callIntent);
	}
