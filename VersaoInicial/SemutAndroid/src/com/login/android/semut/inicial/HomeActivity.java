...
import com.login.android.semut.util.GCM;
...
public class HomeActivity extends DefaultActivity {
	...
	public void onClickSucom(View v) {

		// Intent mainIntent = new Intent(HomeActivity.this,
		// SucomActivity.class);
		// HomeActivity.this.startActivity(mainIntent);
		// findViewById(R.home.elemento2square).setBackgroundColor(getResources().getColor(R.color.sucom_highlighted));

		Intent callIntent = new Intent(Intent.ACTION_CALL, Uri.parse(Constantes.TELOUVIDORIA));
	 ...
	 * 
	 * initColorByGrupo(new Grupo(Long.parseLong(v.getTag().toString())));
	 * 
	 * if (event.getAction() == MotionEvent.ACTION_DOWN) {
	 * v.setBackgroundColor(pressedColorParsed); } else {
