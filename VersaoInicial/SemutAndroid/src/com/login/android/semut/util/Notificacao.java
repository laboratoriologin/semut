...
import com.login.android.semut.inicial.AlertasActivity;
import com.login.android.semut.inicial.HomeActivity;
import com.login.android.semut.inicial.MostraMensagemActivity;
import com.login.android.semut.inicial.OcorrenciaActivity;
...
public class Notificacao {
	...
	public static void mostraNotificacao(String titulo, String mensagem, Context context) {
		...
		// Objeto Notification
		Notification notification = new Notification(R.drawable.ic_launcher_old, titulo, tempoDefinido);
