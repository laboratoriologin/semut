...
$(document).ready(function() {	
	...
	effectButton('botaoStatusBairroA');
	effectButtonMap('superintendencia2');
	effectButtonMap('superintendencia1');
	...
	eventButtonMap("superintendencia1", 1);
	eventButtonMap("superintendencia2", 2);
	...
	$("#superintendencia2").click(function(){
		displayLoad(true);
		$('#superintendencia1').removeClass('opcaoSuperintendenciaAActive');
		$('#superintendencia2').addClass('opcaoSuperintendenciaAActive');
		grupo = 1;	
		loadTiposOcorrencias();
		callFunction(lastCallFunction, lastArg1);		
	});	
	
	$("#superintendencia1").click(function(){
		displayLoad(true);
		$('#superintendencia2').removeClass('opcaoSuperintendenciaAActive');
		$('#superintendencia1').addClass('opcaoSuperintendenciaAActive');
		grupo = 2;		
		loadTiposOcorrencias();
		callFunction(lastCallFunction, lastArg1);
	});	
...
function effectButtonMap(id){
	$('#'+id).hover(function(){
		if($('#'+id).attr('select') == "false")
			$('#'+id+' a').addClass('opcaoSuperintendenciaAHover');
	},function(){
		if($('#'+id).attr('select') == "false")
			$('#'+id+' a').removeClass('opcaoSuperintendenciaAHover');
	});
}
...
function eventButtonMap(id, grupoChoose){
	$("#"+id).click(function(){
		displayLoad(true);
		$('#superintendencia2 a').attr('class', 'opcaoSuperintendenciaA');
		$('#superintendencia1 a').attr('class', 'opcaoSuperintendenciaA');
		$('#superintendencia2').attr('select', "false");
		$('#superintendencia1').attr('select', "false");
		
		$('#'+id+' a').addClass('opcaoSuperintendenciaAActive');
		$('#'+id).attr('select', "true");
		grupo = grupoChoose;	
		loadTiposOcorrencias();
		callFunction(lastCallFunction, lastArg1);	
