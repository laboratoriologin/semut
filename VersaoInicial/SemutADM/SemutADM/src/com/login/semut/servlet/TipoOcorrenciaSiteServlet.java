...
import com.login.semut.dao.TipoOcorrenciaDAO;
 ...
 */
@WebServlet("/site/tipos_ocorrencias")
public class TipoOcorrenciaSiteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TipoOcorrenciaSiteServlet() {
		super();
